// DEPRECATED: Este arquivo não deve mais ser usado
// Todas as seções e perguntas agora vêm diretamente do Supabase
// através do hook useQuestionarioEstruturaDinamica
...
export const getAllQuestions = (): string[] => {
  console.warn('DEPRECATED: getAllQuestions() - Use dados dinâmicos do Supabase');
...
export const getQuestionByIndex = (index: number): string | undefined => {
  console.warn('DEPRECATED: getQuestionByIndex() - Use dados dinâmicos do Supabase');
  const allQuestions = getAllQuestions()
  return allQuestions[index]
}

export const getSectionByQuestionIndex = (questionIndex: number) => {
  console.warn('DEPRECATED: getSectionByQuestionIndex() - Use dados dinâmicos do Supabase');
