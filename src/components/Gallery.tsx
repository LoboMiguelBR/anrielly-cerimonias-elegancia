...
const Gallery: React.FC = () => {
  ...
  // Fallback para imagens estáticas se não houver imagens no banco
  const staticImages = [
    {
      id: "1",
  ...
  // Usar imagens do banco ou fallback para estáticas
  const galleryImages = images.length > 0 ? images.map(img => ({
    id: img.id,
    url: img.image_url,
    title: img.title,
